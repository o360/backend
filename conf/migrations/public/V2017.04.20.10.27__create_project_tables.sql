...
(
    ...
    CONSTRAINT relation_group_auditor_id_fk FOREIGN KEY (group_auditor_id) REFERENCES orgstructure (id) ON UPDATE CASCADE,
    CONSTRAINT relation_form_id_fk FOREIGN KEY (form_id) REFERENCES form (id) ON UPDATE CASCADE,
    CONSTRAINT relation_pk PRIMARY KEY (project_id, group_from_id, group_to_id, group_auditor_id, form_id)
);
